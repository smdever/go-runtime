...
// Flow: LOKIPAI CHAT-Lite
// Version: 1.0.0
// Build: 1
// Generated: 2026-04-29 06:18:15 UTC
// ============================================================

export function createFlow(runtime) {
  const rt = runtime || (typeof globalThis !== 'undefined' ? globalThis : null) || {};
  const info = {"title": "LOKIPAI CHAT-Lite", "accountId": "", "build": 1, "created": "2026-02-02 00:00:01 UTC", "modified": "", "version": "1.0.0", "company": "", "creator": ""};

  const __information = {"compiler": {"name": "LOKIPIED Compiler", "version": "1.0.3"}, "generated": "2026-04-29 06:18:15 UTC", "protection": {"encrypted": false, "scheme": "none"}, "flow": {"title": "LOKIPAI CHAT-Lite", "version": "1.0.0", "build": 1, "accountId": "", "created": "2026-02-02 00:00:01 UTC", "modified": ""}};
  function getInformation(){ return __information; }

  const __runtime = {"Interactors": [{"Name": "Chat", "Provider": "openai", "Model": "gpt-4o", "Role": "Primary"}], "Reasoning": "", "Embedding": "", "Defaults": {"ParallelMode": true, "Bias": false}};
  ...
  const __nodeBlurbs = {"Begin": {}, "Init": {}, "Agree": {}, "CollectInput": {}, "PassToEach": {}, "Gather": {}, "Deliver": {}, "Eject": {}};
